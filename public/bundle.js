...
/***/ function(module, exports, __webpack_require__) {
	...
	var counterApp = __webpack_require__(181);

	var store = createStore(counterApp, window.devToolsExtension ? window.devToolsExtension() : undefined);
	  ...
	  _createClass(Counter, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(Button, { type: 'INCREMENT', value: '+' }),
	        React.createElement(Button, { type: 'DECREMENT', value: '-' })
	      );
	    }
	  }]);
